...
type _AInvariant = RingElement | int | Integer
type _TwistParameter = _AInvariant | None
type _DivisionFieldKeyword = bool | str | int | Integer
type _TorsionKeyword = bool | str | None

class EllipticCurve_field(EllipticCurve_generic, ProjectivePlaneCurve_field):
    def __init__(
        self, R: Ring, data: Sequence[_AInvariant], category: Category | None = ...
    ) -> None: ...
    ...
    def is_quadratic_twist(
        self, other: EllipticCurve_generic
    ) -> RingElement | Integer: ...
    def is_quartic_twist(
        self, other: EllipticCurve_generic
    ) -> RingElement | Integer: ...
    def is_sextic_twist(
        self, other: EllipticCurve_generic
    ) -> RingElement | Integer: ...
    def descend_to(self, K: Ring, f: Map | None = ...) -> list[Element]: ...
    def division_field(
        self,
        n: int | Integer,
        names: str = ...,
        map: bool = False,
        **kwds: _DivisionFieldKeyword,
    ) -> Ring | tuple[Ring, Map]: ...
    def torsion_subgroup(
        self, n: int | Integer, *, extend: bool = False, algorithm: str | None = None
    ) -> AdditiveAbelianGroupWrapper: ...
    def torsion_gens(
    ...
    def _Hom_(
        self, other: EllipticCurve_generic, category: Category | None = ...
    ) -> Homset[Self, EllipticCurve_generic]: ...
    def isogeny(
        self,
        kernel: EllipticCurvePoint_field
    ...
    def kernel_polynomial_from_point(
        self, P: EllipticCurvePoint_field, *, algorithm: str | None = ...
    ) -> Polynomial: ...
    def kernel_polynomial_from_divisor(
        self, f: Polynomial, l: int | Integer, *, check: bool = True
    ) -> Polynomial: ...
    ...
    def isogenies_degree(
        self, n: int | Integer | Factorization, *, _intermediate: bool = False
    ) -> Iterator[EllipticCurveHom]: ...
    def is_isogenous(
        self, other: EllipticCurve_generic, field: Ring | None = None
    ) -> bool: ...
    def weierstrass_p(
        self, prec: int = 20, algorithm: str | None = None
    ) -> LaurentSeries: ...
    def hasse_invariant(self) -> RingElement: ...
    def isogeny_ell_graph(
        self, l: int | Integer, directed: bool = True, label_by_j: bool = False
    ) -> Graph | DiGraph: ...
    def endomorphism_ring_is_commutative(self) -> bool: ...

def compute_model(self, name: str) -> EllipticCurve_generic: ...
def point_of_order(self, n: int | Integer) -> EllipticCurvePoint_field: ...
