...
class StringMonoid_class:
    def __init__(
        self, n: builtins.int, alphabet: builtins.tuple[_SageObject, ...] = ...
    ) -> None: ...
    def __contains__(self, x: object) -> bool: ...
    def alphabet(self) -> tuple[Element, ...]: ...
...
class BinaryStringMonoid:
    ...
    def __call__(
        self, x: builtins.object, check: builtins.bool = ...
    ) -> _SageObject: ...
    def encoding(
        self, S: builtins.object, padic: builtins.bool = ...
    ) -> _SageObject: ...
