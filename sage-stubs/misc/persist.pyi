...
unpickle_override: dict[
    tuple[str, str], tuple[Callable[..., object] | type, str | None]
]
_T = TypeVar("_T")
...
def _base_save(
    obj: object, filename: str | PathLike[str], compress: bool = ...
) -> str: ...
def save(
    obj: object, filename: str | PathLike[str], compress: bool = ..., **kwargs: object
) -> None: ...
...
class SagePickler(_BasePickler):
    def __init__(
        self,
        file_obj: io.BufferedIOBase,
        persistent_id: Callable[[object], object] | int | None = ...,
        py2compat: bool = ...,
    ) -> None: ...
    @classmethod
...
def loads(s: bytes, compress: bool = ..., **kwargs: object) -> object | None: ...
def picklejar(obj: object, dir: str | None = ...) -> None: ...
def unpickle_all(
    target: str, debug: bool = ..., run_test_suite: bool = ...
) -> list[tuple[type[BaseException], BaseException, object]] | None: ...
def make_None(*args: object, **kwds: object) -> None: ...
def load_sage_object(cls, dic: dict[str, object]) -> _T: ...
def load_sage_element(cls, parent: object, dic_pic: bytes) -> _T: ...
