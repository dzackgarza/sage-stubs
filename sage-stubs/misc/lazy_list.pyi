...
class lazy_list_from_iterator(lazy_list_generic):
    ...
    def __init__(
        self,
        iterator: Iterator[object] | _LazyListMaterialized | None,
        cache: _LazyListMaterialized | int | None = None,
        stop: int | None = None,
    ) -> None: ...
    def __reduce__(self) -> tuple[object, ...]: ...
    def _update_cache_up_to(self, i: int) -> int: ...
...
class lazy_list_from_function(lazy_list_generic):
    ...
    def __init__(
        self,
        function: Callable[[int], object] | _LazyListMaterialized | None,
        cache: _LazyListMaterialized | int | None = None,
        stop: int | None = None,
    ) -> None: ...
    def __reduce__(self) -> tuple[object, ...]: ...
...
def slice_unpickle(
    master: lazy_list_generic, start: int, stop: int, step: int
) -> lazy_list_generic: ...
