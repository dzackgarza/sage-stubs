...
class CmpKey:
    ...
    def __get__(self, inst: object, cls: type[SageObject]) -> tuple[int, int]: ...
...
def C3_sorted_merge(
    lists: list[list[object]], key: Callable[[object], object] = ...
...
class HierarchyElement(metaclass=ClasscallMetaclass):
    ...
    @staticmethod
    def __classcall__(
        cls, value: object, succ: object, key: Callable[[object], object] | None = None
    ) -> HierarchyElement: ...
    def __init__(
        self,
        value: object,
