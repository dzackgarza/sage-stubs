...
class _lazy_attribute(Generic[_Owner, _Value]):
    ...
    @overload
    def __get__(
        self, instance: None, owner: type[_Owner]
    ) -> _lazy_attribute[_Owner, _Value]: ...
    @overload
    def __get__(self, instance: _Owner, owner: type[_Owner]) -> _lazy_attribute: ...
...
class lazy_class_attribute(_lazy_attribute[_Owner, _Value]):
    ...
    def __get__(
        self, instance: None, owner: type[_Owner]
    ) -> lazy_class_attribute[_Owner, _Value]: ...
    @overload
    def __get__(
