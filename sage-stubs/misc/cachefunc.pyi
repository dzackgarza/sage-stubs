...
class CachedFunction(Generic[_P, _R]):
    ...
    def __call__(self, *args: _P.args, **kwds: _P.kwargs) -> CachedFunction: ...
    def cached(self, *args: _P.args, **kwds: _P.kwargs) -> CachedFunction: ...
...
class CachedMethod(Generic[_Owner, _P, _R]):
    ...
    def __call__(
        self, inst: _Owner, *args: _P.args, **kwds: _P.kwargs
    ) -> CachedMethod: ...
    def __get__(
        self, inst: _Owner, cls: type[_Owner]
    ) -> CachedMethodCaller[_P, CachedMethod]: ...
...
class CachedMethodCallerNoArgs(CachedFunction[[], _R]):
    def __call__(self) -> CachedMethodCallerNoArgs: ...
...
class GloballyCachedMethodCaller(CachedMethodCaller[_P, _R]):
    def get_key_args_kwds(
        self, args: tuple[_T, ...], kwds: dict[str, _T]
    ) -> Hashable: ...
...
@overload
def cached_function(
    *, key: Callable[_P, Hashable] | None = ..., do_pickle: bool = ...
