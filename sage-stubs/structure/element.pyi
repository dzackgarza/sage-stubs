...
class Element(Protocol):
    ...
    # element.pyx:647-658 forwards to the parent's base_ring. The generic
    # CategoryObject owner (565-621) returns its stored base parent or None,
    # not a Rings.ParentMethods implementation class.
...
class RingElement(ModuleElement, Protocol):
    ...
    # element.pyx:2829 returns parent().one() / self, possibly in a fraction field.
