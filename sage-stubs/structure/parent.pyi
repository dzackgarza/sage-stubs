...
class Parent(CategoryObject, Generic[_E]):
    ...
    def Hom(
        ...
        category: Sets,
    ) -> Homset[SetMorphism, _E, _CodomainElement]: ...
    @overload
    def Hom(
        self,
        codomain: Parent[_CodomainElement],
        category: Category | None = ...,
    ) -> Homset[Map, _E, _CodomainElement]: ...
    ...
    def __call__(self, x: ElementConstructorInput = ..., *args: ElementConstructorInput, **kwds: ElementConstructorInput) -> _E: ...
    def an_element(self) -> _E: ...
    def _an_element_(self) -> _E: ...
    def structure_morphism(self) -> Morphism: ...
    def zero(self) -> Element: ...
    def base(self) -> Parent[Element] | None: ...
    def base_ring(self) -> CommutativeRing | Rings.ParentMethods[RingElement] | None: ...
    def algebra(
        self,
        base_ring: Ring | None = ...,
        category: Category | None = ...,
    ...
    def coerce_map_from(self, source: Parent[_SourceElement]) -> Morphism[_SourceElement, _E] | None: ...
