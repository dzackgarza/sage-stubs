...
class DoubleCosetReduction:
    ...
    def sign(self) -> int: ...
    def igamma(
        self, embedding: int | Callable[[Parent], Matrix] | None = None, scale: int = 1
    ) -> Matrix: ...
...
class Vertex:
    entering_edges: list[Edge] | None
    leaving_edges: list[Edge] | None
    valuation: int | Integer | None
    determinant: Integer | None
    rep: Matrix
    label: int
    p: int | Integer
    ...
    def __init__(
        ...
        label: int,
        rep: Matrix,
        leaving_edges: list[Edge] | None = None,
        entering_edges: list[Edge] | None = None,
        determinant: Integer | None = None,
        valuation: int | Integer | None = None,
    ) -> None: ...
...
class Edge:
    ...
    def __init__(
        ...
        origin: Vertex,
        target: Vertex,
        links: list[Parent] | None = None,
        opposite: Edge | None = None,
        determinant: Integer | None = None,
        valuation: int | Integer | None = None,
    ) -> None: ...
...
class BruhatTitsQuotient:
    ...
    def get_maximal_order(
        self, magma: bool = False, force_computation: bool = False
    ) -> Parent | MagmaElement: ...
    def get_eichler_order(
        self, magma: bool = False, force_computation: bool = False
    ) -> Parent | MagmaElement: ...
