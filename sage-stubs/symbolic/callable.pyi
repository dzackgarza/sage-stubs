...
from sage.structure.factory import FactoryArgument, FactoryCacheKey, FactoryVersion
...
class CallableSymbolicExpressionFunctor(ConstructionFunctor):
    ...
    def unify_arguments(self, x: CallableSymbolicExpressionFunctor) -> CallableArguments: ...
