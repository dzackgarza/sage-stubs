...
class ImageSubobject(
    ...
    def __init__(
        self,
        map: Map[_DomainElement, _CodomainElement] | Callable[[_DomainElement], _CodomainElement],
        domain_subset: Parent[_DomainElement],
        *,
        category: Category | None = ...,
        is_injective: bool | str | None = ...,
        inverse: Map[_CodomainElement, _DomainElement] | Callable[[_CodomainElement], _DomainElement] | None = ...,
    ) -> None: ...
...
class ImageSet(ImageSubobject[_DomainElement, _CodomainElement], Set_base, Set_add_sub_operators, Set_boolean_operators): ...
