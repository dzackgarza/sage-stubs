...
type _Predicate = Callable[..., bool] | Expression
type _Name = str | Expression
type _Names = _Name | Iterable[_Name]
type _SetElementInput = Element | Hashable | list[Hashable]
type _ConditionUniverse = CategoryObject | Set_base | Iterable[_SetElementInput]
...
class ConditionSet(
    ...
    def _element_constructor_(
        self, *args: ParentCallInput, **kwds: ParentCallInput
    ) -> Element: ...
    def _call_predicate(
        self, predicate: _Predicate, element: Element | Sequence[Element]
    ) -> bool | Expression: ...
