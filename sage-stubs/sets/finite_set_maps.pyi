...
class FiniteSetMaps(UniqueRepresentation, Parent):
    ...
    def __classcall_private__(
        ...
        | FiniteSetMaps_Set
        | FiniteSetEndoMaps_N
        | FiniteSetEndoMaps_Set
    ): ...
    def cardinality(self) -> Integer: ...

class FiniteSetMaps_MN(FiniteSetMaps):
    def __init__(
        self, m: Integer | int, n: Integer | int, category: Category | None = ...
    ) -> None: ...
...
class FiniteSetMaps_Set(FiniteSetMaps_MN):
    def __init__(
        self,
        domain: Parent | FiniteEnumeratedSet | Integer | int,
        codomain: Parent | FiniteEnumeratedSet | Integer | int,
        category: Category | None = ...,
    ) -> None: ...
...
class FiniteSetEndoMaps_Set(FiniteSetMaps_Set, FiniteSetEndoMaps_N):
    def __init__(
        self,
        domain: Parent | FiniteEnumeratedSet | Integer | int,
        action: str | Parent | FiniteEnumeratedSet = ...,
        category: Category | None = ...,
    ) -> None: ...
