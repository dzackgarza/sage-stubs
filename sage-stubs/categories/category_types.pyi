...
class Category_over_base(CategoryWithParameters):
    def __init__(self, base: Category | Parent, name: str | None = None) -> None: ...
    @classmethod
...
class Category_in_ambient(Category):
    def __init__(self, ambient: Parent, name: str | None = None) -> None: ...
...
class Category_ideal(Category_in_ambient):
    ...
    def __contains__(self, x: object) -> bool: ...
    def __call__(self, v: object) -> Element: ...
