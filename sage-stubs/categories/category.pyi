...
type _CategoryOption = (
    Category | bool | int | Integer | str | type | tuple[str, ...] | None
)
...
class Category(UniqueRepresentation, SageObject):
    ...
    @staticmethod
    def __classcall__(
        cls, *args: _CategoryArg, **options: _CategoryOption
    ) -> Category: ...
    @classmethod
    def _set_classcall(cls, value: type[SageObject]) -> None: ...
    ...
    def _make_named_class(
        self,
        name: str,
        method_provider: type[SageObject],
        cache: bool = ...,
        picklable: bool = ...,
    ) -> type[SageObject]: ...
    ...
    def _without_axioms(self, named: bool = ...) -> Self: ...
...
def category_sample(self) -> tuple[Category, ...]: ...
