...
class SkewTableau(ClonableList[tuple[int | None, ...]]):
    ...
    def slide(
        self, corner: tuple[int, int] | None = ..., return_vacated: bool = ...
    ) -> SkewTableau | tuple[SkewTableau, tuple[int, int]]: ...
    ...
    ) -> Tableau | StandardTableau | SemistandardTableau: ...
...
class SkewTableaux(UniqueRepresentation, Parent):
    ...
    def from_shape_and_word(
        self, shape: SkewPartition, word: list[int]
    ) -> SkewTableau: ...

class StandardSkewTableaux(SkewTableaux):
    @staticmethod
    def __classcall_private__(
        cls: type[StandardSkewTableaux], skp: object = ...
    ) -> (
...
class SemistandardSkewTableaux(SkewTableaux):
    @staticmethod
    def __classcall_private__(
        cls: type[SemistandardSkewTableaux],
        skp: object = ...,
        max_entry: int | None = ...,
    ) -> (
