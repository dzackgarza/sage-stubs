...
class TensorProductOfCrystals(CrystalOfWords):
    @staticmethod
    def __classcall_private__(cls: type, *crystals: Parent, **options: object) -> TensorProductOfCrystals: ...
    ...
    def module_generators(self) -> list[TensorProductOfCrystalsElement]: ...
...
class CrystalOfTableaux(CrystalOfWords):
    @staticmethod
    def __classcall_private__(cls: type, cartan_type: object, shape: object = ..., **kwds: object) -> CrystalOfTableaux: ...
    def cartan_type(self) -> sage.combinat.root_system.cartan_type.CartanType: ...
