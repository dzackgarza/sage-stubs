...
def stdout_to_string(self) -> _SageObject: ...
def max_to_string(self) -> _SageObject: ...

my_mread: _SageObject

def parse_max_string(self) -> _SageObject: ...
...
class MaximaLibElement:
    ...
    def to_poly_solve(
        self, vars: builtins.object, options: builtins.str = ...
    ) -> _SageObject: ...
...
def reduce_load_MaximaLib(self) -> _SageObject: ...
...
def sage_rat(self, y: builtins.object) -> _SageObject: ...
...
def mrat_to_sage(self) -> _SageObject: ...
def mqapply_to_sage(self) -> _SageObject: ...
def mdiff_to_sage(self) -> _SageObject: ...
def mlist_to_sage(self) -> _SageObject: ...
def max_at_to_sage(self) -> _SageObject: ...
def dummy_integrate(self) -> _SageObject: ...
def max_harmonic_to_sage(self) -> _SageObject: ...
def max_pochhammer_to_sage(self) -> _SageObject: ...
...
def pyobject_to_max(self) -> _SageObject: ...
def sr_to_max(self) -> _SageObject: ...

max_to_pynac_table: _SageObject

def max_to_sr(self) -> _SageObject: ...
