...
class Matrix_numpy_dense(
    ...
    def row(self, i: int, from_list: bool = ...) -> FreeModuleElement[_NumpyScalar]: ...
    def column(self, j: int, from_list: bool = ...) -> FreeModuleElement[_NumpyScalar]: ...
    def _add_(self, right: Self) -> Self: ...
    def _sub_(self, right: Self) -> Self: ...
    def _lmul_(self, scalar: _NumpyScalar) -> Self: ...
    ...
    @overload
    def numpy(self: Matrix_numpy_dense[RealDoubleElement]) -> _RealArray: ...
    @overload
    def numpy(self: Matrix_numpy_dense[ComplexDoubleElement]) -> _ComplexArray: ...
    @overload
    def numpy(self) -> _NumpyArray: ...
    def _replace_self_with_numpy(self, numpy_matrix: _NumpyArray) -> None: ...
