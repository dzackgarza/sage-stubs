...
class Matrix_modn_dense_float(Matrix_dense[IntegerMod_abstract]):
    def __init__(
        self,
    ...
    def stack(
        self,
        bottom: Self | FreeModuleElement[IntegerMod_abstract],
        subdivide: bool = ...,
    ) -> Self: ...
    def submatrix(
        self,
    ...
    def right_kernel(self) -> FreeModule_generic[IntegerMod_abstract]: ...
    def left_kernel(self) -> FreeModule_generic[IntegerMod_abstract]: ...
