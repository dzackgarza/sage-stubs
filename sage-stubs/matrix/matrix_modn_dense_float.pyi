...
class Matrix_modn_dense_template(Matrix_dense[IntegerMod_int]):
    def __init__(
        self,
    ...
    def determinant(self) -> IntegerMod_int: ...
    def randomize(
        self,
        density: float = ...,
        nonzero: bool = ...,
    ...
    def _list(self) -> list[IntegerMod_int]: ...
