...
class Matrix_integer_sparse:
    def __cinit__(self) -> Matrix_integer_sparse: ...
    def __dealloc__(self) -> Matrix_integer_sparse: ...
    def __init__(
        self,
    ...
    def rational_reconstruction(self, N: builtins.object) -> Matrix_integer_sparse: ...
    def elementary_divisors(
        self, algorithm: builtins.object = ...
    ) -> Matrix_integer_sparse: ...
    def smith_form(
        self, transformation: builtins.object = ..., integral: builtins.object = ...
    ) -> Matrix_integer_sparse: ...
