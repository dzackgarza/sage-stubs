...
def join(*args: builtins.object) -> builtins.str | None: ...

def var(key: builtins.str, *fallbacks: builtins.object, force: builtins.bool = ...) -> _SageObject: ...
...
def sage_include_directories(use_sources: builtins.bool = ...) -> _SageObject: ...

default_required_modules: _SageObject
default_optional_modules: _SageObject
def cython_aliases(required_modules: builtins.object = ..., optional_modules: builtins.object = ...) -> _SageObject: ...

def sage_data_paths(name: builtins.str = ...) -> builtins.set[builtins.str]: ...
