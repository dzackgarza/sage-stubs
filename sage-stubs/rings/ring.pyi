...
type _IdealKwds = bool | type[Ideal] | Literal["twosided", "left", "right"]
...
class Ring(Parent):
    ...
    def __xor__(self, n: int | Integer) -> NoReturn: ...
    ...
    def quotient(self, I: Ideal | NumberFieldIdeal, names: NameSpec = None) -> Ring: ...
...
def _is_Field(x: Parent | Element | int | Integer) -> bool: ...
