...
class FiniteFieldHomomorphism_givaro(FiniteFieldHomomorphism_generic):
    def __init__(self, parent: FiniteFieldHomset, im_gens: tuple[Element, ...] | None = None, check: bool = False) -> None: ...
    def _call_(self, x: Element) -> Element: ...
...
class FrobeniusEndomorphism_givaro(FrobeniusEndomorphism_finite_field):
    ...
    def fixed_field(self) -> tuple[FiniteField_givaro, FiniteFieldHomomorphism_givaro]: ...
