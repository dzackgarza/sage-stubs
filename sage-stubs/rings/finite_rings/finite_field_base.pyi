...
class FiniteField(Field):
    ...
    def free_module(
        self,
        base: Ring | None = ...,
        basis: list[FiniteRingElement] | None = ...,
        map: bool = ...,
    ) -> (
        VectorSpace_class
        | tuple[
    ...
    def extension(
        self,
        poly: int | Polynomial | NumberFieldElement,
        name: str | None = ...,
    ...
    def subfield(
        self, degree: int, name: str | None = ..., map: bool = ...
    ) -> FiniteField | tuple[FiniteField, RingHomomorphism, RingHomomorphism]: ...
    def subfields(
    ...
    def dual_basis(
        self, basis: list[FiniteRingElement] | None = ..., check: bool = ...
    ) -> list[FiniteRingElement]: ...
    def from_bytes(
        self, input_bytes: bytes | Iterable[int], byteorder: str = ...
    ) -> FiniteRingElement: ...
...
def unpickle_FiniteField_prm(
    _type: type, order: int, variable_name: str, kwargs: dict[str, FactoryArgument]
) -> FiniteField: ...
