...
class FiniteField(Field):
    ...
    def extension(
        self,
        modulus: int | Polynomial | NumberFieldElement,
        name: str | None = ...,
        names: str | tuple[str, ...] | None = ...,
        map: bool | str | None = ...,
        embedding: RingHomomorphism | str | tuple[str, ...] | None = ...,
    ) -> FiniteField | tuple[FiniteField, RingHomomorphism]: ...
    def subfield(
...
def unpickle_FiniteField_prm(
    _type: type[SageObject], order: int, variable_name: str, kwargs: dict[str, object]
) -> FiniteField: ...
