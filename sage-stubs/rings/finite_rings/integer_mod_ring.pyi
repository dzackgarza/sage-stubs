...
def _unit_gens_primepowercase(
    self, r: int | Integer
) -> list[tuple[IntegerMod_abstract, Integer]]: ...
def crt(self) -> IntegerMod_abstract: ...

class IntegerModRing_generic(
    QuotientRing_generic,
    sage.rings.abc.IntegerModRing,
    Rings.ParentMethods[IntegerMod_abstract],
):
    def __init__(
        self,
        order: int | Integer | Ring,
        cache: bool | Ideal_generic | None = ...,
        category: Category | str | tuple[str, ...] | None = ...,
    ) -> None: ...
    ...
    def list_of_elements_of_multiplicative_group(self) -> list[Element]: ...
    def multiplicative_subgroups(
        self,
    ) -> tuple[tuple[IntegerMod_abstract, ...], ...]: ...
    ...
    def _lift_residue_field_root(
        ...
        f: Polynomial,
        fprime: Polynomial,
        root: IntegerMod_abstract,
    ) -> tuple[IntegerMod_abstract, ...]: ...
    @overload
    def _roots_univariate_polynomial(
        ...
        algorithm: str | None = ...,
    ) -> list[tuple[IntegerMod_abstract, int]]: ...
    @overload
    def _roots_univariate_polynomial(
        self,
        f: Polynomial,
    ...
    def _roots_univariate_polynomial(
        ...
        multiplicities: bool = ...,
        algorithm: str | None = ...,
    ) -> list[IntegerMod_abstract] | list[tuple[IntegerMod_abstract, int]]: ...
