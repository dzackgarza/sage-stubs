...
class RationalField(NumberField, Fields.ParentMethods[Rational]):
    ...
    def _is_valid_homomorphism_(
        self,
        codomain: Parent,
        im_gens: Sequence[Rational | int | Integer],
        base_map: Map | None = ...,
    ) -> bool: ...
    ...
    def places(
        self, all_complex: bool = ..., prec: int | PlusInfinity | None = ...
    ) -> list[Map]: ...
    ...
    def hilbert_symbol_negative_at_S(
        self, S: list[Integer | int], b: int | Integer | Rational, check: bool = ...
    ) -> Rational: ...
    ...
    def selmer_group_iterator(
        self, S: Sequence[Integer | int], m: int, proof: bool = ...
    ) -> Iterator[Rational]: ...
    def selmer_space(
        self, S: Sequence[Integer | int], p: int, proof: bool | None = ...
    ) -> tuple[
        Parent,
        list[Rational],
    ...
    def quadratic_defect(
        self, a: int | Integer | Rational, p: Integer | Ideal_generic, check: bool = ...
