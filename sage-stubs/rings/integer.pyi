...
class Integer(EuclideanDomainElement):
    ...
    @overload
    def __mul__(
        self, right: FreeModuleElement[Integer | Rational]
    ) -> FreeModuleElement[Integer | Rational]: ...
    @overload
    def __mul__(self, right: _BuiltinList[_T]) -> _BuiltinList[_T]: ...
    @overload
    def __mul__(self, right: tuple[_T, ...]) -> tuple[_T, ...]: ...
    @overload
    def __mul__(self, right: _BuiltinStr) -> _BuiltinStr: ...
    @overload
    ...
    @overload
    def __rmul__(self, left: _BuiltinList[_T]) -> _BuiltinList[_T]: ...
    @overload
    def __rmul__(self, left: tuple[_T, ...]) -> tuple[_T, ...]: ...
    @overload
    def __rmul__(self, left: _BuiltinStr) -> _BuiltinStr: ...
    @overload
    ...
    def list(self) -> _BuiltinList[Integer]: ...
    def str(self, base: int = ...) -> _BuiltinStr: ...
    def ordinal_str(self) -> _BuiltinStr: ...
    def hex(self) -> _BuiltinStr: ...
    def oct(self) -> _BuiltinStr: ...
    def binary(self) -> _BuiltinStr: ...
    def bits(self) -> _BuiltinList[Integer]: ...
    ...
    def divisors(self, method: _BuiltinStr | None = ...) -> _BuiltinList[Integer]: ...
    ...
    def support(self) -> _BuiltinList[Integer]: ...
    ...
    def round(self, mode: _BuiltinStr = ...) -> Integer: ...
    ...
    def prime_factors(self) -> _BuiltinList[Integer]: ...
    def prime_divisors(self) -> _BuiltinList[Integer]: ...
    ...
    def to_bytes(
        self, length: int = ..., byteorder: _BuiltinStr = ..., is_signed: bool = ...
    ) -> bytes: ...
