...
from sage.rings.abc import RealField as RealField_abc
...
_RoundMode: TypeAlias = Literal["RNDN", "RNDZ", "RNDU", "RNDD", "RNDA", "RNDF"]
_RealInput: TypeAlias = RealNumber | RealDoubleElement | SageCoercionAtom
_RealArithmeticInput: TypeAlias = RealNumber | Integer | Rational | int | float
_RealLogBase: TypeAlias = Literal["e"] | _RealInput | None

class RealField_class(RealField_abc):
    def __init__(self, prec: int = ..., sci_not: int = ..., rnd: _String = ...) -> None: ...
    ...
    def random_element(
        self,
        min: _RealArithmeticInput = ...,
        max: _RealArithmeticInput = ...,
        distribution: str | None = ...,
    ) -> RealNumber: ...
    def factorial(self, n: int) -> RealNumber: ...
    def rounding_mode(self) -> _String: ...
...
class RealNumber(Element):
    ...
    def str(
        ...
        digits: int = ...,
        *,
        no_sci: bool | int | None = ...,
        e: str | None = ...,
        truncate: bool = ...,
        skip_zeroes: bool = ...,
    ) -> _String: ...
    def hex(self) -> _String: ...
    ...
    def round(self, mode: _String | None = ...) -> Integer: ...
    ...
    def nearby_rational(
        self,
        max_error: _RealArithmeticInput | None = ...,
        max_denominator: int | Integer | None = ...,
    ) -> Rational: ...
    ...
    def log(self, base: _RealLogBase = ...) -> RealNumber | ComplexNumber: ...
    def log2(self) -> RealNumber: ...
