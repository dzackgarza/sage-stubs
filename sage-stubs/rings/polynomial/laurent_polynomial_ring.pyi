...
def _split_dict_(
    self, indices: object, group_by: object = None
) -> dict[object, object]: ...
def _split_laurent_polynomial_dict_(
    self, M: object, d: object
) -> dict[object, object]: ...
def from_fraction_field(self, x: object) -> LaurentPolynomial: ...
