...
def _base_ring_to_fraction_field(self) -> Ring: ...
def _minimal_vanishing_polynomial(
    self, eval_pts: object
) -> SkewPolynomial_generic_dense: ...
def _lagrange_polynomial(
    self, eval_pts: object, values: object
) -> SkewPolynomial_generic_dense: ...
...
class SkewPolynomialCenterInjection(RingHomomorphism):
    def __init__(
        self, domain: object | Homset, codomain: object, embed: object, order: object
    ) -> None: ...
    def _repr_(self) -> str: ...
    def _call_(self, x: object) -> Element: ...
    def _richcmp_(self, right: object, op: int) -> bool: ...
...
class SkewPolynomialRing_finite_field(SkewPolynomialRing_finite_order):
    ...
    def _retraction(
        self, x: object, newmap: bool = False, seed: object = None
    ) -> Element: ...
