...
class PolynomialQuotientRing_generic(QuotientRing_generic):
    def __init__(
        self,
        ring: Ring,
        polynomial: Polynomial | Ideal_generic,
    ...
    def S_class_group(
        self, S: object, proof: bool = True
    ) -> list[tuple[tuple[PolynomialQuotientRingElement, ...], int]]: ...
    def class_group(
        self, proof: bool = True
    ) -> list[tuple[tuple[PolynomialQuotientRingElement, ...], int]]: ...
    def S_units(
        self, S: object, proof: bool = True
    ) -> list[PolynomialQuotientRingElement]: ...
    def units(self, proof: bool = True) -> list[PolynomialQuotientRingElement]: ...
    def selmer_generators(
        self, S: object, m: int, proof: bool = True
    ) -> list[PolynomialQuotientRingElement]: ...
