...
class TropicalPolynomial(Polynomial_generic_sparse):
    def parent(self) -> TropicalPolynomialSemiring: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]
    def roots(self) -> list[TropicalSemiringElement[ModuleElement]]: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]
    def split_form(self) -> TropicalPolynomial: ...
    def factor(self, **kwargs: ElementConstructorInput) -> Factorization: ...
...
class TropicalPolynomialSemiring(
    ...
    def base_ring(self) -> TropicalSemiring[ModuleElement]: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]
