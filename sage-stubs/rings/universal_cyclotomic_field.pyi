...
class UniversalCyclotomicFieldElement(FieldElement):
    ...
    @overload
    def sqrt(
        self, extend: bool = ..., all: Literal[False] = ...
    ) -> UniversalCyclotomicFieldElement: ...
    @overload
    def sqrt(
        self, extend: bool = ..., all: Literal[True] = ...
    ) -> list[UniversalCyclotomicFieldElement]: ...
    @overload
    def sqrt(
        self, extend: bool = ..., all: bool = ...
    ) -> UniversalCyclotomicFieldElement | list[UniversalCyclotomicFieldElement]: ...
    def conjugate(self) -> UniversalCyclotomicFieldElement: ...
    def galois_conjugates(self, n: int | Integer | None = ...) -> list[Element]: ...
...
class UniversalCyclotomicField(
    ...
    def gen(
        self, n: int | Integer, k: int | Integer = ...
    ) -> UniversalCyclotomicFieldElement: ...
    zeta = gen
