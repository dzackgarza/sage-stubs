...
class ComplexField_class(ComplexField_abc):
    ...
    def __call__(self, *args: object, **kwargs: object) -> ComplexNumber: ...
...
class ComplexNumber(FieldElement):
    ...
    def str(self, **kwds: object) -> str: ...
    def norm(self) -> RealNumber: ...
    def abs_c(self) -> RealNumber: ...
    def norm_c(self) -> RealNumber: ...
    def _new(self) -> ComplexNumber: ...
    def _add_(self, other: ComplexNumber) -> ComplexNumber: ...
    def _mul_(self, other: ComplexNumber) -> ComplexNumber: ...
    def prec(self) -> Integer: ...
