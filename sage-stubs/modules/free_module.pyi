...
class FreeModule_generic(
    ...
    def base_field(self) -> Parent[FieldElement]: ...
    def coordinate_ring(self) -> Parent[RingElement]: ...
    def free_module(self) -> Self: ...
    def has_user_basis(self) -> bool: ...
    def nonembedded_free_module(self) -> FreeModule_ambient[_Scalar]: ...
    ...
    def are_linearly_dependent(
        self,
        vecs: Iterable[FreeModuleInput[_Scalar]],
    ) -> bool: ...
    def _magma_init_(self, magma: Expect) -> str: ...
    def _macaulay2_(self, macaulay2: Expect | None = ...) -> ExpectElement: ...
    def __radd__(self, other: int | Integer) -> Self: ...
