...
class RepresentationType:
    def is_split(self) -> builtins.bool: ...
...
class CubicHeckeMatrixSpace:
    @staticmethod
    def __classcall_private__(cls: builtins.object, cubic_hecke_algebra: builtins.object, representation_type: builtins.object = ..., subdivide: builtins.bool = ..., original: builtins.bool = ...) -> _SageObject: ...
    def __init__(self, base_ring: builtins.object, dimension: builtins.int, cubic_hecke_algebra: builtins.object, representation_type: builtins.object, subdivide: builtins.object) -> None: ...
    def construction(self) -> _SageObject: ...
    def __reduce__(self) -> builtins.str | builtins.tuple[builtins.object, ...]: ...
    def __call__(self, entries: builtins.object = ..., coerce: builtins.bool = ..., copy: builtins.bool = ...) -> _SageObject: ...
