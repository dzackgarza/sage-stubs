...
class DiffForm(TensorField):
    ...
    def interior_product(
        self, qvect: MultivectorField | MultivectorFieldParal
    ) -> _InteriorResult: ...
...
class DiffFormParal(FreeModuleAltForm, TensorFieldParal, DiffForm):
    ...
    @overload
    def wedge(
        self, other: FreeModuleAltForm | DiffForm | DiffScalarField
    ) -> FreeModuleAltForm: ...
    @overload
    def interior_product(
        self, qvect: MultivectorFieldParal
    ) -> DiffScalarField | MultivectorFieldParal: ...
    @overload
    def interior_product(
        self, qvect: MultivectorField | MultivectorFieldParal
    ) -> _InteriorResult: ...
    @overload
    def interior_product(
        self, qvect: AlternatingContrTensor | MultivectorField | MultivectorFieldParal
