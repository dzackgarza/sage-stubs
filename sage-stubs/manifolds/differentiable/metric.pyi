...
type _Signature = int | Integer
type _FrameOrChart = FreeModuleBasis | Chart | None
type _Component = Element | Expression | Integer | int
...
class PseudoRiemannianMetric(TensorField):
    def __init__(
        ...
        name: str | TensorType,
        signature: _Signature | str | None = None,
    ...
    ) -> CompWithSym[_Component, _Component, int | Integer]: ...
