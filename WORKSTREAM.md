...
| Missing-sidecar non-tensor lane audit | Banach / GPT-5.5 low | agent fork workspace | `019e583c-5768-7533-ac04-169f94ee7e50` | no edits | current 99 `missing sidecar ordinary signature` rows excluding known non-goals and the free-module tensor dependency cycle | `ordinary_error_count=1746` | active no-edit audit lane; Spark unavailable/exhausted, so GPT-5.5 low fallback used explicitly | close after no-edit audit report or follow-on lane split |
