...
| Lazy callable stream | Hubble / GPT-5.5 low | agent fork workspace | `019e5788-4897-7181-a11b-c4737a9ba885` | `misc/lazy_import.pyi`, `categories/covariant_functorial_construction.pyi` | `LazyImport` callability, lazy category factories, `TensorProductFunctor` callable rows | `ordinary_error_count=1759` | active; Spark attempt `019e5787-c547-79d2-b5c1-7f2cf43268f7` closed after usage cap | close after merge/rejection and registry update |
| Posets provider-method audit | Pasteur / GPT-5.5 low | agent fork workspace | `019e5788-86ea-7ff3-bf3d-9e1cf3f979ed` | `categories/posets.pyi`, `categories/finite_posets.pyi`, `categories/finite_lattice_posets.pyi`, `combinat/posets/posets.pyi` | poset order operations, finite poset/lattice morphism callable domains | `ordinary_error_count=1759` | active; Spark attempt `019e5788-00e7-7a83-8e54-ffb7aced9a27` closed after usage cap | close after merge/rejection and registry update |
| Integer/numeric protocol audit | Mendel / GPT-5.5 low | agent fork workspace | `019e5789-89dc-75a3-9f9f-d284269806d5` | `rings/integer.pyi` | `Integer` constructor/protocol/arithmetic/comparison rows, excluding combinatorics k-domain | `ordinary_error_count=1759` | active after Spark capacity exhaustion | close after merge/rejection and registry update |
