...
| Reflexive finite-rank sidecars | Pascal / GPT-5.5 low | agent fork workspace | `019e576d-e684-72e2-a1f1-3a4d66b2cc39` | `tensor/modules/reflexive_module.pyi`, finite-rank return sidecars | finite-rank free-module method return sidecars | `ordinary_error_count=1759` | active | close after accepted patch or blocker evidence |
| Sets provider missing signatures | Carson / GPT-5.5 low | agent fork workspace | `019e576e-6a1f-7611-acde-45964a734f09` | `categories/sets_cat.pyi`, enumerated/finite/facade set category stubs | `is_facade`, `is_countable`, `is_uncountable`, `__len__`, `random_element`, maybe `_coerce_map_from_` | `ordinary_error_count=1759` | active | close after accepted patch or reclassification evidence |
