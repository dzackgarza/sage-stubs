...
| CategoryWithAxiom cleanup candidate | Newton / GPT-5.5 low | agent fork workspace | `019e57a6-a47e-7f33-b491-ebeb4501729d` | `categories/category_with_axiom.pyi` | resolve `defining_predicate(candidate: object)` policy debt and add source-backed `CategoryWithAxiom.__init__(base_category)` | `ordinary_error_count=1759` | active after Spark capacity exhaustion | close after merge/rejection and registry update |
