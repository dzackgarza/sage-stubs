...
| T01.9 | `sage.cpython` — public surface: `getattr`, `string`, `type`, `debug`, `atexit`, `builtin_types`. | ~6 | T01.1 | 🟡 In Progress | Subagent. |
| T01.10 | `sage.data_structures` — `blas_dict`, `bounded_integer_sequences`, `mutable_poset`, `stream`, `binary_search`, `bitset`, `list_of_pairs`, `sparse_bitset` (Python-facing only). | ~8 | T01.1 | 🟡 In Progress | Subagent. |
