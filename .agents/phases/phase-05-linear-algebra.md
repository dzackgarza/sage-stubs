...
| T05.4 | **Matrix specialised dense** — `matrix_double_dense`, `matrix_double_sparse`, `matrix_real_double_dense`, `matrix_complex_double_dense`, `matrix_complex_ball_dense`, `matrix_mpolynomial_dense`, `matrix_polynomial_dense`, `matrix_laurent_mpolynomial_dense`. | 8 | T05.2 | 🟡 In Progress | The double-precision dense and sparse hierarchy and the RDF/CDF concrete specializations are source-grounded; the complex-ball and polynomial backends remain. |
