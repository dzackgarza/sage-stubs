...
| T05.2 | **Matrix abstract bases** — `matrix0`, `matrix1`, `matrix_dense`, `matrix_sparse`, `matrix_generic_dense`, `matrix_generic_sparse`. | 6 | T05.1 | 🟡 | `matrix1`, the dense and sparse bases, and both generic implementations are source-grounded; `matrix0` remains. |
