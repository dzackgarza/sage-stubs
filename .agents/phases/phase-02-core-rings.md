...
| T02.4 | **Algebraic numbers & continued fractions** — `qqbar`, `qqbar_decorators`, `continued_fraction`, `continued_fraction_gosper`, `universal_cyclotomic_field`, `imaginary_unit`. | ~6 | — | ✅ Done | qqbar.pyi completed (17 classes), continued_fraction.pyi completed (4 classes + factories), UCF degree/algebraic_closure added. |
| T02.5 | **Ring base classes & morphisms** — `ring`, `generic`, `morphism`, `homset`, `ideal`, `ideal_monoid`, `noncommutative_ideals`, `commutative_algebra`, `derivation`, `abc`. | ~10 | — | ✅ Done | New: generic, homset, ideal_monoid, noncommutative_ideals, commutative_algebra, derivation (+ minimal homology/free_resolution deps). Completed: morphism (8 classes), ideal (4 classes). |
| T02.6 | **Power / Laurent / Puiseux series** — `power_series_ring`, `power_series_ring_element`, `power_series_poly`, `power_series_mpoly`, `power_series_pari`, `laurent_series_ring`, `laurent_series_ring_element`, `puiseux_series_ring`, `puiseux_series_ring_element`, `big_oh`. | ~10 | T02.5 | ✅ Done | New: power_series_poly/mpoly/pari, puiseux_series_ring_element, big_oh. Completed: power_series_ring (+2 classes), laurent_series_ring, laurent_series_ring_element. |
